...
**NOTE:** JLCPCB has a `panel` option, where they'll lay multiples of these out in a single board. Here's an example of 25 qty ordered in a 5x5 panel. The board price will go up quite a bit for this though.
